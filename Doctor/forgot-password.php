...
echo "<script>alert('Incorrect details. Please try with correct details');</script>";
		...
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<div class="box-login">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> </span>. <span>All rights are reserved</span>
					</div>
