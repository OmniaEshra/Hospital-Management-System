...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">all patients </h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor </span>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15"> All Patients Record   <span class="text-bold">registers</span></h5>
