...
<html lang="en">
	<head>
		<title> Patient Adminstration</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle"> patient adminstration</h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor </span>
...
Write patient name to search for 
</label>
...
$sdata=$_POST['searchdata'];
  ?>
<h4 align="center">Search result for"<?php echo $sdata;?>" keyword</h4>
...
<th>Reports Creation Date</th>
<th>The Last Update for Report Date </th>
<th>Condition</th>
</tr>
</thead>
<tbody>
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="8">There is no patient with this name </td>
