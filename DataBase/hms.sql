...
--
-- Return or import table data `admin`
--
...
--
-- Return or import table data `appointment`
--

INSERT INTO `appointment` (`id`, `doctorSpecialization`, `doctorId`, `userId`, `consultancyFees`, `appointmentDate`, `appointmentTime`, `postingDate`, `userStatus`, `doctorStatus`, `updationDate`) VALUES
(14, '????? ????', 11, 11, 455, '2021-09-23', '3:30 PM', '2021-09-05 09:55:56', 1, 0, '2021-09-05 09:56:42'),
(15, 'Surgery', 11, 11, 455, '2021-09-28', '1:00 PM', '2021-09-05 09:56:59', 0, 1, '2021-09-05 09:57:28');

-- --------------------------------------------------------

--
-- Table Structures `doctors`
--
...
--
-- Return or import table data `doctors`
--

INSERT INTO `doctors` (`id`, `specilization`, `doctorName`, `address`, `docFees`, `contactno`, `docEmail`, `password`, `creationDate`, `updationDate`) VALUES
(11, 'General Surgeon', 'Dr. Ali Sameh', 'Egypt-Cairo', '455', 8754987541, 'ali1@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-08-30 13:12:34', '2021-09-05 09:55:16'),
(13, 'Orthopedist', 'Dr. Moneer Saber', 'Egypt-Alex', '25', 8754987541, 'ali2@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-04 22:17:30', '2021-09-04 22:20:07'),
(14, 'General Surgeron', 'Dr. Hazem Amgad', 'Egypt-Cairo', '10', 8754987541, 'ali3@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-04 22:19:00', '2021-09-04 22:20:20'),
(15, 'Cardiologist', 'Dr. Mohamed Yassin', 'Egypt-Cairo', '15', 8754987541, 'ali4@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-04 22:21:09', NULL),
(16, 'Plastic Surgeon', 'Dr. Maha Salem', 'Egypt-Alex', '25', 8754987541, 'ali5@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-04 22:22:23', NULL),
(17, 'Oncologist', 'Dr. Yasser Ahmed', 'Egypt-Alex', '25', 8754987541, 'ali6@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-04 22:25:18', NULL),
(18, 'Dermatologist', 'Dr. Mariam Hossam', 'Egypt-Alex', '10', 8754987541, 'ali7@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-04 22:26:16', NULL),
(19, 'Hematologist', 'Dr. Lucas Samir', 'Egypt-Alex', '20', 8754987541, 'ali8@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-04 22:27:20', NULL),
(20, 'Neurosurgeon', 'Dr. Mazen Bassem', 'Egypt-Cairo', '50', 8754987541, 'ali9@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-04 22:28:26', NULL),
(21, 'Allergist', 'Dr. Ramy Reda', 'Egypt-Cairo', '30', 8754987541, 'ali10@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-04 22:29:35', NULL);

-- --------------------------------------------------------

--
-- Table Structure `doctorslog`
--
...
--
-- Return or import table data `doctorslog`
--
...
--
-- Table Structures `doctorspecilization`
--
...
--
-- Return or import table data `doctorspecilization`
--

INSERT INTO `doctorspecilization` (`id`, `specilization`, `creationDate`, `updationDate`) VALUES
(17, 'Orthopedist', '2021-09-04 12:21:30', NULL),
(18, 'General Surgeon', '2021-09-04 12:21:47', NULL),
(19, 'Cardiologist', '2021-09-04 12:22:00', NULL),
(20, 'Plastic Surgeon', '2021-09-04 12:22:15', NULL),
(21, 'Radiologist', '2021-09-04 12:22:31', NULL),
...
(28, 'Pediatrician', '2021-09-04 22:10:53', '2021-09-04 22:11:02'),
(29, 'Psychiatrist', '2021-09-04 22:11:28', NULL),
(30, 'Allergist', '2021-09-04 22:11:47', NULL),
(31, 'Gynecologist', '2021-09-04 22:12:04', NULL),
(32, 'Neurosurgeon', '2021-09-04 22:12:30', NULL),
(33, 'Endocrinologist', '2021-09-04 22:12:52', NULL);

-- --------------------------------------------------------

--
-- Table Structures `tblcontactus`
--
...
--
-- Return or Import table data `tblcontactus`
--

INSERT INTO `tblcontactus` (`id`, `fullname`, `email`, `contactno`, `message`, `PostingDate`, `AdminRemark`, `LastupdationDate`, `IsRead`) VALUES
(6, 'Omnia', 'teds@gmail.com', 4521754874, ' 425425', '2021-09-04 11:07:45', 'Done', '2021-09-04 11:16:38', 1),
(7, 'Mariam', 'teds@gmail.com', 4521754874, 'Whatever', '2021-09-04 11:08:39', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table Structures `tblmedicalhistory`
--
...
--
-- Return or import `tblmedicalhistory`
--

INSERT INTO `tblmedicalhistory` (`ID`, `PatientID`, `BloodPressure`, `BloodSugar`, `Weight`, `Temperature`, `MedicalPres`, `CreationDate`) VALUES
(12, 8, 'Normal', 'Normal', '85', 'Normal', 'Normal', '2021-09-04 12:19:08');

-- --------------------------------------------------------

--
-- Table Structures `tblpatient`
--
...
--
-- Return or Import tables data `tblpatient`
--

INSERT INTO `tblpatient` (`ID`, `Docid`, `PatientName`, `PatientContno`, `PatientEmail`, `PatientGender`, `PatientAdd`, `PatientAge`, `PatientMedhis`, `CreationDate`, `UpdationDate`) VALUES
(8, 11, 'Yousef Ahmad', 4514754154, 'admin12@gmail.com', 'Male', 'Egypt ', 40, 'Everything is normal', '2022-09-04 12:18:45', NULL);

-- --------------------------------------------------------

--
-- Table Structures `userlog`
--
...
--
-- Return or Import table data `userlog`
--
...
(11, 'Omnia', 'Egypt-Alex', 'Alex', 'Female', 'admin12@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '2021-09-05 09:54:18', NULL);
...
--
-- Table Structures `pma__bookmark`
--
...
--
-- Table Structures `pma__central_columns`
--
...
--
-- Return or Import table data `pma__central_columns`
--
...
--
-- Table Structures `pma__column_info`
--
...
--
-- Table Structures `pma__designer_settings`
--
...
--
-- Return or Import table data `pma__designer_settings`
--
...
--
-- Table Structures `pma__export_templates`
--
...
--
-- Table Structures `pma__favorite`
--
...
--
--  Table Structures `pma__navigationhiding`
--
...
--
-- Table Structures `pma__pdf_pages`
--
...
--
-- Return or Import table data `pma__recent`
--
...
--
-- Table Structures `pma__relation`
--
...
--
-- Table Structures `pma__savedsearches`
--
...
--
-- Table Structures `pma__table_coords`
--
...
--
-- Table Structures `pma__table_info`
--
...
--
-- Table Structures `pma__table_uiprefs`
--
...
--
-- Return or Import table data `pma__userconfig`
--
...
--
-- Table Structures `pma__usergroups`
--
