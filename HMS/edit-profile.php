				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Edit Account Info</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Patient </span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Edit Account </h5>
												</div>
...
<p><b>Account Creation Date: </b><?php echo htmlentities($data['regDate']);?></p>
<?php if($data['updationDate']){?>
<p><b>Update Date: </b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
...
<div class="form-group">
					...
					<a href="change-emaild.php">Update E-mail</a>
														</div>
