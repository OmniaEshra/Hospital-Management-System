				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">All Patient Appointments</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Patients </span>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th>The Statue of Appointment Now </th>
												<th>The Appointment Statue </th>
...
{
	echo "The appointment has been canceled by the patient ";
}

if(($row['userStatus']==1) && ($row['doctorStatus']==0))  
{
	echo "The appointment has been canceled by the doctor ";
}
...
echo "there is nothing untill now  ";
	 } else {
