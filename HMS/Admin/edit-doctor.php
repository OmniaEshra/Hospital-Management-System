				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Edit Doctor Data </h1>
																	</div>
								<ol class="breadcrumb">
									<li>
...
<p><b> The date of the last update of the account</b><?php echo htmlentities($data['updationDate']);?></p>
<?php } ?>
<hr />
