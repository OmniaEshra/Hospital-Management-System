...
<html lang="en">
	<head>
		<title>Specialization Editing </title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Specialization Editing </h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<li class="active">
										<span> Specialization Editing</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-6 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Doctor Specialization Editing</h5>
												</div>
