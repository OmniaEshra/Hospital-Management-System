								...
								<ul class="sub-menu">
									<li>
										<a href="doctor-specilization.php">
											<span class="title">Doctors Specilizations</span>
										</a>
									</li>
									<li>
										<a href="add-doctor.php">
											<span class="title">Add New Doctor</span>
										</a>
									</li>
									<li>
				...
				<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title">Consultations</span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									...
									<li>
										<a href="unread-queries.php">
											<span class="title">Unread Consultations</span>
										</a>
									</li>

									<li>
										<a href="read-query.php">
											<span class="title">Read Consultations</span>
										</a>
									</li>
	...
	<li>
								<a href="doctor-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title">Doctors Log</span>
										</div>
									</div>
								</a>
							</li>		
							...
							<li>
								<a href="user-logs.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title">Users Log</span>
										</div>
									</div>
								</a>
							</li>						
				<li>
								...
								<ul class="sub-menu">
									...
									<li>
										<a href="between-dates-reports.php">
											<span class="title">Reports according to dates </span>
										</a>
									</li>
								...
								<a href="patient-search.php">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title">Search for patient report</span>
										</div>
									</div>
								</a>
							</li>
