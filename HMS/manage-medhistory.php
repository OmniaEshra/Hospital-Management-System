...
<html lang="en">
	<head>
		<title>Notes about the patient</title>
...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle">Doctors' notes about the patient</h1>
</div>
<ol class="breadcrumb">
<li>
...
<div class="row">
<div class="col-md-12">
<h5 class="over-title margin-bottom-15">Display <span class="text-bold">All doctors' notes about the patient</span></h5>
